...
export const uploadMusicianMedia = async (token: string, endpoint: string, fieldName: string, files: File | File[]) => {
...
export const deleteMusicianMedia = async (token: string, endpoint: string, url: string) => {
